...
const BASEMAP_OPTIONS: Array<{
  ...
  { key: "imagery", label: "影像", helper: "ArcGIS World Imagery", Icon: Satellite },
...
const LAYER_OPTIONS: Array<{
  ...
  { key: "grid", label: "联动热力网格", helper: "按当前范围请求 /stats/grid", Icon: Grid2X2 },
  { key: "globalWms", label: "全球 WMS", helper: "occurrence_grid_monthly", Icon: Globe2 }
];
